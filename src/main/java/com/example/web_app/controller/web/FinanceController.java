...
public class FinanceController {
    ...
    public FinanceController(FileTreeService fileTreeService) {
        this.fileTreeService = fileTreeService;
    }

    @GetMapping("/{type}/finance")
    public String financePage(
        ...
        model.addAttribute("secondary", "FINANCE");
        model.addAttribute("role", role);

        model.addAttribute("sidebar", fileTreeService.buildTree(type + "/FINANCE"));
